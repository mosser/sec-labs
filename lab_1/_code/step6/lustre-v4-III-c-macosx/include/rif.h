...
public:
        ...
        char* error_msg();
        char* cur_value();
        int is_bool_value(char* v);
        int is_bool_value(char* v, int* res);
        int is_int_value(char* v);
        int is_int_value(char* v, long* res);
        int is_real_value(char* v);
        int is_real_value(char* v, double* res);
        int is_bottom_value(char* v);
